<%-- 
    Document   : withdraw
    Created on : 12-Apr-2025, 2:09:05 pm
    Author     : Rahul Kumar
--%>
...
<body class="bg-light">
    <div class="container mt-5">
        <div class="text-center mb-4">
            <h2 class="fw-bold text-danger">Withdraw Money</h2>
        </div>
        ...
        <div class="card shadow p-4">
            <form action="WithdrawMoneyServlet" method="post">
                <div class="mb-3">
                    ...
                    <input type="number" class="form-control" name="amount" id="amount" min="0" placeholder="e.g. 500">
                </div>
                <div class="d-flex justify-content-between">
                    <button type="submit" class="btn btn-danger px-4">Withdraw</button>
